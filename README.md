...
- Or use [executable installers](https://github.com/spyder-ide/spyder/releases)

For Spyder 3.x there are no installers (see #2648), so use
`pip` way to test current beta:
