...
if [ "$USE_CONDA" = "yes" ]; then
    ...
    pip install -q --no-deps git+https://github.com/spyder-ide/spyder-kernels.git@refs/pull/192/head
    ...
    pip install -q git+https://github.com/spyder-ide/spyder-kernels.git@refs/pull/192/head
