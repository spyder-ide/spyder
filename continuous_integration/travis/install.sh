...
if [ "$USE_CONDA" = "yes" ]; then
    ...
    pip install -q --no-deps git+https://github.com/spyder-ide/spyder-kernels.git@refs/pull/142/head
else
    ...
    pip install -q git+https://github.com/spyder-ide/spyder-kernels.git@refs/pull/142/head
