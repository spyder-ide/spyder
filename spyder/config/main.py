...
SHOW_EXT = [".py", ".ipynb", ".dat", ".pdf", ".png", ".svg", ".md", ".yml", ".yaml"]
...
DEFAULTS = [
    ...
    (
        "quick_layouts",
        {"place_holder": "", "names": [], "order": [], "active": [], "ui_names": []},
    ),
    (
        "internal_console",
        {
    ...
    (
        "shortcuts",
        {
            ...
            "editor/duplicate line up": ("Ctrl+Alt+Up" if WIN else "Shift+Alt+Up"),
