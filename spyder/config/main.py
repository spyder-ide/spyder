            ...
            ('shortcuts',
             {
              ...
              "editor/save bookmark 0": "Ctrl+Shift+0",
              "editor/save bookmark 1": "Ctrl+Shift+1",
              "editor/save bookmark 2": "Ctrl+Shift+2",
              "editor/save bookmark 3": "Ctrl+Shift+3",
              "editor/save bookmark 4": "Ctrl+Shift+4",
              "editor/save bookmark 5": "Ctrl+Shift+5",
              "editor/save bookmark 6": "Ctrl+Shift+6",
              "editor/save bookmark 7": "Ctrl+Shift+7",
              "editor/save bookmark 8": "Ctrl+Shift+8",
              "editor/save bookmark 9": "Ctrl+Shift+9",
              "editor/go to bookmark 0": "Ctrl+Alt+0",
              "editor/go to bookmark 1": "Ctrl+Alt+1",
              "editor/go to bookmark 2": "Ctrl+Alt+2",
              "editor/go to bookmark 3": "Ctrl+Alt+3",
              "editor/go to bookmark 4": "Ctrl+Alt+4",
              "editor/go to bookmark 5": "Ctrl+Alt+5",
              "editor/go to bookmark 6": "Ctrl+Alt+6",
              "editor/go to bookmark 7": "Ctrl+Alt+7",
              "editor/go to bookmark 8": "Ctrl+Alt+8",
              "editor/go to bookmark 9": "Ctrl+Alt+9",
              # -- In Breakpoints
