            ...
            ('appearance',
             {
              ...
              'black/pastel/ctrlclick':   "#678cb1",
              'black/pastel/sideareas':   "#000000",
              'black/pastel/matched_p':   "#616161",
              'black/pastel/unmatched_p': "#95bed8",
              'black/pastel/normal':     ('#c0c0c0', False, False),
              'black/pastel/keyword':    ('#82677e', False, False),
              'black/pastel/builtin':    ('#e0e2e4', False, False),
              ...
              'gedit/original/oblivion/sideareas':   "#2e3436",
              'gedit/original/oblivion/matched_p':   "#000000",
              ...
              'gedit/original/oblivion/builtin':    ('#555753', False, False),
              ...
              'havenjark/ctrlclick':   "#a893cc",
              'havenjark/sideareas':   "#2d3639",
              'havenjark/matched_p':   "#616161",
              'havenjark/unmatched_p': "#2a4750",
              'havenjark/normal':     ('#c0b6a8', False, False),
              'havenjark/keyword':    ('#a38474', False, False),
              'havenjark/builtin':    ('#00001f', False, False),
              ...
              'inkpot/ctrlclick':   "#2d2d44",
              'inkpot/sideareas':   "#1f1f27",
              'inkpot/matched_p':   "#616161",
              'inkpot/unmatched_p': "#8b8bff",
              'inkpot/normal':     ('#cfbfad', False, False),
              'inkpot/keyword':    ('#808bed', False, False),
              'inkpot/builtin':    ('#2d2d44', False, False),
              ...
              'minimal/sideareas':   "#ffffff",
              'minimal/matched_p':   "#efefef",
              ...
              'nightlion/aptana/theme/ctrlclick':   "#a893cc",
              'nightlion/aptana/theme/sideareas':   "#1e1e1e",
              'nightlion/aptana/theme/matched_p':   "#616161",
              ...
              'nightlion/aptana/theme/builtin':    ('#505050', False, False),
              ...
              'oblivion/ctrlclick':   "#d9e577",
              'oblivion/sideareas':   "#1e1e1e",
              'oblivion/matched_p':   "#000000",
              'oblivion/unmatched_p': "#000000",
              'oblivion/normal':     ('#d8d8d8', False, False),
              'oblivion/keyword':    ('#ffffff', False, False),
              'oblivion/builtin':    ('#7fb347', False, False),
              ...
              'obsidian/ctrlclick':   "#678cb1",
              'obsidian/sideareas':   "#293134",
              'obsidian/matched_p':   "#616161",
              'obsidian/unmatched_p': "#804000",
              'obsidian/normal':     ('#e0e2e4', False, False),
              'obsidian/keyword':    ('#93c763', False, False),
              'obsidian/builtin':    ('#e0e2e4', False, False),
              ...
              'pastel/ctrlclick':   "#678cb1",
              'pastel/sideareas':   "#1f2223",
              'pastel/matched_p':   "#616161",
              'pastel/unmatched_p': "#95bed8",
              'pastel/normal':     ('#e0e2e4', False, False),
              'pastel/keyword':    ('#a57b61', False, False),
              'pastel/builtin':    ('#e0e2e4', False, False),
              ...
              'recogneyes/ctrlclick':   "#d9e577",
              'recogneyes/sideareas':   "#101020",
              'recogneyes/matched_p':   "#000000",
              'recogneyes/unmatched_p': "#0000ff",
              'recogneyes/normal':     ('#d0d0d0', False, False),
              'recogneyes/keyword':    ('#00d0d0', False, False),
              'recogneyes/builtin':    ('#ffffff', False, False),
              ...
              'sublime/text/2/ctrlclick':   "#cfbfad",
              'sublime/text/2/sideareas':   "#272822",
              'sublime/text/2/matched_p':   "#000000",
              'sublime/text/2/unmatched_p': "#cc9900",
              'sublime/text/2/normal':     ('#cfbfad', False, False),
              'sublime/text/2/keyword':    ('#ff007f', False, False),
              'sublime/text/2/builtin':    ('#5b5a4e', False, False),
              ...
              'sunburst/ctrlclick':   "#548fa0",
              'sunburst/sideareas':   "#000000",
              'sunburst/matched_p':   "#5a5a5a",
              'sunburst/unmatched_p': "#ddf0ff",
              'sunburst/normal':     ('#f9f9f9', False, False),
              'sunburst/keyword':    ('#ea9c77', False, False),
              'sunburst/builtin':    ('#7fb347', False, False),
              ...
              'vibrant/ink/ctrlclick':   "#814582",
              'vibrant/ink/sideareas':   "#191919",
              'vibrant/ink/matched_p':   "#616161",
              'vibrant/ink/unmatched_p': "#414c3b",
              'vibrant/ink/normal':     ('#ffffff', False, False),
              'vibrant/ink/keyword':    ('#ec691e', False, False),
              'vibrant/ink/builtin':    ('#408000', False, False),
              ...
              'wombat/ctrlclick':   "#a7a7d1",
              'wombat/sideareas':   "#242424",
              'wombat/matched_p':   "#616161",
              'wombat/unmatched_p': "#898941",
              'wombat/normal':     ('#f6f3e8', False, False),
              'wombat/keyword':    ('#8ac6f2', False, False),
              'wombat/builtin':    ('#656565', False, False),
              ...
              'wombat/instance':   ('#f6f3e8', False, False)
             }),
            ('lsp-server', {
                'python': {
                    'index': 0,
