            ...
            ('shortcuts',
             {
              ...
              "editor/bookmark current position to slot 0": "Ctrl+Shift+0",
              "editor/bookmark current position to slot 1": "Ctrl+Shift+1",
              "editor/bookmark current position to slot 2": "Ctrl+Shift+2",
              "editor/bookmark current position to slot 3": "Ctrl+Shift+3",
              "editor/bookmark current position to slot 4": "Ctrl+Shift+4",
              "editor/bookmark current position to slot 5": "Ctrl+Shift+5",
              "editor/bookmark current position to slot 6": "Ctrl+Shift+6",
              "editor/bookmark current position to slot 7": "Ctrl+Shift+7",
              "editor/bookmark current position to slot 8": "Ctrl+Shift+8",
              "editor/bookmark current position to slot 9": "Ctrl+Shift+9",
              "editor/go to bookmarked position in slot 0": "Ctrl+Alt+0",
              "editor/go to bookmarked position in slot 1": "Ctrl+Alt+1",
              "editor/go to bookmarked position in slot 2": "Ctrl+Alt+2",
              "editor/go to bookmarked position in slot 3": "Ctrl+Alt+3",
              "editor/go to bookmarked position in slot 4": "Ctrl+Alt+4",
              "editor/go to bookmarked position in slot 5": "Ctrl+Alt+5",
              "editor/go to bookmarked position in slot 6": "Ctrl+Alt+6",
              "editor/go to bookmarked position in slot 7": "Ctrl+Alt+7",
              "editor/go to bookmarked position in slot 8": "Ctrl+Alt+8",
              "editor/go to bookmarked position in slot 9": "Ctrl+Alt+9",
              # -- In Breakpoints
