            ...
            ('color_schemes',
             {
              ...
              #        Name            Color     Bold  Italic
              'solarized/background':  '#fdf6e3',
              'solarized/currentline': '#eee8d5',
              'solarized/currentcell': '#eee8d5',
              'solarized/occurence':   '#839496',
              'solarized/ctrlclick':   '#d33682',
              'solarized/sideareas':   '#eee8d5',
              'solarized/matched_p':   '#586e75',
              'solarized/unmatched_p': '#dc322f',
              'solarized/normal':     ('#657b83', False, False),
              'solarized/keyword':    ('#859900', False, False),
              'solarized/builtin':    ('#6c71c4', False, False),
              'solarized/definition': ('#268bd2', True, False),
              'solarized/comment':    ('#93a1a1', False, True),
              'solarized/string':     ('#2aa198', False, False),
              'solarized/number':     ('#cb4b16', False, False),
              'solarized/instance':   ('#b58900', False, True),
              # ---- Solarized Dark ----
