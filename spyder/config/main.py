            ...
            ('shortcuts',
             {
              ...
              'editor/go to previous occurrence': '',
              'editor/go to next occurrence': '',
              'editor/add cursor previous occurrence': '',
              'editor/add cursor next occurrence': '',
