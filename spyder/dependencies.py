...
DESCRIPTIONS = [
    ...
    },
    {
        ...
        "package_name": "parso",
        "features": _(
            "Python parser that supports error recovery and " "round-trip parsing"
        ),
    ...
    },
    {
        ...
        "features": _(
            "Autoformat Python files in the Editor with the Black " "package"
        ),
    ...
    },
    {
        ...
        "package_name": "sphinx",
        "features": _(
            "Show help for objects in the Editor and Consoles in a dedicated pane"
        ),
...
DESCRIPTIONS += [
    ...
    },
    {
        ...
        "package_name": "numpy",
        "features": _(
            "View and edit two and three dimensional arrays in the Variable Explorer"
        ),
...
def add(
    ...
    for dependency in DEPENDENCIES:
        ...
        if dependency.modname == modname:
            raise ValueError(f"Dependency has already been registered: {modname}")

    DEPENDENCIES += [
        Dependency(
            modname, package_name, features, required_version, installed_version, kind
        )
    ]
