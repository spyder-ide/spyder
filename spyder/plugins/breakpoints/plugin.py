...
class Breakpoints(SpyderDockablePlugin):
    ...
    def on_editor_available(self):
        ...
        widget.sig_clear_all_breakpoints_requested.connect(editor.clear_all_breakpoints)
    ...
    def on_editor_teardown(self):
        ...
        widget.sig_clear_breakpoint_requested.disconnect(editor.clear_breakpoint)
