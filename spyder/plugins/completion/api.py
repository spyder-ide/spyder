...
WORKSPACE_CAPABILITIES = {
    ...
    "executeCommand": {
        ...
        "symbolKind": {
            ...
            "valueSet": [
                value
                for value in SymbolKind.__dict__.values()
...
class SpyderCompletionProvider(QObject, CompletionConfigurationObserver):
    ...
    def __init__(self, parent, config):
        ...
        """
        self.CONF_SECTION = parent.CONF_SECTION if parent is not None else "completions"
    ...
    def send_request(self, language: str, req_type: str, req: dict, req_id: int):
        """
    ...
    def broadcast_notification(self, notification_type: str, notification: dict):
        """
    ...
    def project_path_update(self, project_path: str, update_kind: str, instance: Any):
        """
    ...
    def start(self):
        ...
        """
        raise NotImplementedError("A completion provider must implement start()")
    ...
    def get_conf(
        ...
        return self.main.get_conf(option_name, default=default, section=section)
    ...
    def get_menu(name, context: Optional[str] = None, plugin: Optional[str] = None):
    ...
    def add_item_to_menu(self, action_or_menu, menu, section=None, before=None):
        ...
        """
        self.main.add_item_to_menu(action_or_menu, menu, section=section, before=before)

    def add_item_to_application_menu(
        self, item, menu_id=None, section=None, before=None, before_section=None
    ):
        """
