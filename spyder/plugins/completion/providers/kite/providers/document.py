...
from spyder.plugins.completion.providers.kite.decorators import send_request, handles
...
KITE_DOCUMENT_TYPES = defaultdict(
    lambda: CompletionItemKind.VALUE,
    {
                ...
                if "children" in completion:
                    for j, child in enumerate(completion["children"]):
                        child_entry = {
                            ...
                            "textEdit": {
                                "newText": convert_text_snippet(child["snippet"]),
                                "range": {
