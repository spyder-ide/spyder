...
"""
Spyder Language Server Client Wrapper.

It uses pygls JsonRPCClient (SpyderPyglsClient) with a dedicated asyncio
...
class LSPClient(QObject, LSPMethodProviderMixIn, SpyderConfigurationAccessor):
    ...
    def __init__(
        ...
        # LSP capabilities
        self.client_capabilites = self._build_client_capabilities()
        ...
        # pygls client
        self._pygls_client = SpyderPyglsClient(
