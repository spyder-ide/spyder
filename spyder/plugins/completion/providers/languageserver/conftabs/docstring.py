...
from qtpy.QtWidgets import QGridLayout, QLabel, QMessageBox, QVBoxLayout, QWidget
...
class DocstringConfigTab(SpyderPreferencesTab):
    ...
    def __init__(self, parent):
        ...
        pep257_url = "<a href='https://www.python.org/dev/peps/pep-0257/'>PEP 257</a>"
        docstring_style_codes = _(
            "<a href='http://www.pydocstyle.org/en/stable" "/error_codes.html'>page</a>"
        )
        docstring_style_label = QLabel(
            _(
                "Here you can decide if you want to perform style analysis on "
                "your docstrings according to the {} or {} conventions. You can "
                "also decide if you want to show or ignore specific errors, "
                "according to the codes found on this {}."
            ).format(numpy_url, pep257_url, docstring_style_codes)
        )
        ...
        docstring_style_g_layout.addWidget(docstring_style_convention.label, 1, 0)
        docstring_style_g_layout.addWidget(docstring_style_convention.combobox, 1, 1)
        docstring_style_g_layout.addWidget(self.docstring_style_select.label, 2, 0)
        docstring_style_g_layout.addWidget(self.docstring_style_select.textbox, 2, 1)
        docstring_style_g_layout.addWidget(self.docstring_style_ignore.label, 3, 0)
        docstring_style_g_layout.addWidget(self.docstring_style_ignore.textbox, 3, 1)
        docstring_style_g_layout.addWidget(self.docstring_style_match.label, 4, 0)
        docstring_style_g_layout.addWidget(self.docstring_style_match.textbox, 4, 1)
        docstring_style_g_layout.addWidget(self.docstring_style_match_dir.label, 5, 0)
        docstring_style_g_layout.addWidget(self.docstring_style_match_dir.textbox, 5, 1)
        ...
        self.docstring_style_check.toggled.connect(docstring_style_g_widget.setEnabled)
    ...
    def report_invalid_regex(self, files=True):
        ...
        """
        msg = _(
            "Directory patterns listed for matching should be valid "
            "regular expressions"
        )
        if files:
            msg = _(
                "File patterns listed for matching should be valid "
                "regular expressions"
            )
    ...
    def is_valid(self):
        ...
        try:
            docstring_style_match = self.docstring_style_match.textbox.text()
        ...
        try:
            docstring_style_match_dir = self.docstring_style_match_dir.textbox.text()
