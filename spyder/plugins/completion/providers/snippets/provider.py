...
from spyder.plugins.completion.api import SpyderCompletionProvider, SUPPORTED_LANGUAGES
from spyder.plugins.completion.providers.snippets.actor import SnippetsActor
from spyder.plugins.completion.providers.snippets.conftabs import SnippetsConfigTab
...
class SnippetsProvider(SpyderCompletionProvider):
    ...
    def __init__(self, parent, config):
        ...
        self.snippets_actor.sig_snippets_ready.connect(self.signal_provider_ready)
