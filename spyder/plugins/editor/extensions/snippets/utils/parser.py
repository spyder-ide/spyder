...
ANY -> name | int | CONDITIONALS | SYMBOLS | whitespace | left_curly_name
COLONS -> : | :+ | :- | :?
CONDITIONALS -> if | else | case
SYMBOLS ->  COLONS | \$ | text_pipe | { | \} | \\ | \/ | , | symbol
...
INTSNIPPET -> { int INTSNIPPETBODY }
INTSNIPPETBODY -> COLONBODY | PIPEBODY | EPSILON
COLONBODY -> : EXPRLIST
PIPEBODY -> pipe TEXTSEQ pipe

TEXTSEQ -> ANY MORETEXT
MORETEXT -> , ANY MORETEXT | EPSILON

VARSNIPPET -> left_curly_name VARSNIPPETBODY }
...
IFOPTS -> :+ if
IFELSEOPTS -> :? if : else
ELSEOPTS -> PROLOGFUNCT else
PROLOGFUNCT -> : | :-
REGEX -> TEXT | EPSILON
OPTIONS -> TEXT | EPSILON
"""
