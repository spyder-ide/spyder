...
class CodeEditor(TextEditBaseWidget):
    ...
    def log_lsp_handle_errors(self, message, error=None):
        """
        ...
        if get_debug_level() > 0:
            ...
            if PY2 and error:
                # For Python 2 we need the actual error so we can raise it
                raise error
    ...
    def linting_diagnostics(self, params):
        ...
        try:
            ...
            self.log_lsp_handle_errors("Error when processing linting", e)
    ...
    def process_completion(self, params):
        ...
        try:
            ...
            self.log_lsp_handle_errors('Error when processing completions', e)
    ...
    def process_signatures(self, params):
        ...
        try:
            ...
            self.log_lsp_handle_errors("Error when processing signature", e)
    ...
    def handle_hover_response(self, contents):
        ...
        try:
            ...
            self.log_lsp_handle_errors("Error when processing hover", e)
