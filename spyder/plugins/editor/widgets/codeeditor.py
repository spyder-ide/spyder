...
class GoToLineDialog(QDialog):
    def __init__(self, editor):
        ...
        glayout = QGridLayout()
        glayout.addWidget(label, 0, 0, int(Qt.AlignVCenter | Qt.AlignRight))
        glayout.addWidget(self.lineedit, 0, 1, Qt.AlignVCenter)
        glayout.addWidget(cl_label, 1, 0, int(Qt.AlignVCenter | Qt.AlignRight))
        glayout.addWidget(cl_label_v, 1, 1, Qt.AlignVCenter)
        glayout.addWidget(last_label, 2, 0, int(Qt.AlignVCenter |
                                                Qt.AlignRight))
