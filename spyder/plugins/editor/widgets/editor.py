...
#        self.next_btn = None
    ...
    def create_shortcuts(self):
        ...
        close_split = config_shortcut(self.close_split,
                                      ...
                                      parent=self)
        save_bookmark_1 = config_shortcut(lambda:
                                          self.sig_save_bookmark.emit(0),
                                          context="Editor",
                                          name="bookmark current position "
                                               "to slot 0",
                                          parent=self)
        save_bookmark_2 = config_shortcut(lambda:
                                          self.sig_save_bookmark.emit(1),
                                          context="Editor",
                                          name="bookmark current position "
                                               "to slot 1",
                                          parent=self)
        save_bookmark_3 = config_shortcut(lambda:
                                          self.sig_save_bookmark.emit(2),
                                          context="Editor",
                                          name="bookmark current position "
                                               "to slot 2",
                                          parent=self)
        save_bookmark_4 = config_shortcut(lambda:
                                          self.sig_save_bookmark.emit(3),
                                          context="Editor",
                                          name="bookmark current position "
                                               "to slot 3",
                                          parent=self)
        save_bookmark_5 = config_shortcut(lambda:
                                          self.sig_save_bookmark.emit(4),
                                          context="Editor",
                                          name="bookmark current position "
                                               "to slot 4",
                                          parent=self)
        save_bookmark_6 = config_shortcut(lambda:
                                          self.sig_save_bookmark.emit(5),
                                          context="Editor",
                                          name="bookmark current position "
                                               "to slot 5",
                                          parent=self)
        save_bookmark_7 = config_shortcut(lambda:
                                          self.sig_save_bookmark.emit(6),
                                          context="Editor",
                                          name="bookmark current position "
                                               "to slot 6",
                                          parent=self)
        save_bookmark_8 = config_shortcut(lambda:
                                          self.sig_save_bookmark.emit(7),
                                          context="Editor",
                                          name="bookmark current position "
                                               "to slot 7",
                                          parent=self)
        save_bookmark_9 = config_shortcut(lambda:
                                          self.sig_save_bookmark.emit(8),
                                          context="Editor",
                                          name="bookmark current position "
                                               "to slot 8",
                                          parent=self)
        save_bookmark_10 = config_shortcut(lambda:
                                           self.sig_save_bookmark.emit(9),
                                           context="Editor",
                                           name="bookmark current position "
                                                "to slot 9",
                                           parent=self)
        load_bookmark_1 = config_shortcut(lambda:
                                          self.sig_load_bookmark.emit(0),
                                          context="Editor",
                                          name="go to bookmarked position "
                                               "in slot 0",
                                          parent=self)
        load_bookmark_2 = config_shortcut(lambda:
                                          self.sig_load_bookmark.emit(1),
                                          context="Editor",
                                          name="go to bookmarked position "
                                               "in slot 1",
                                          parent=self)
        load_bookmark_3 = config_shortcut(lambda:
                                          self.sig_load_bookmark.emit(2),
                                          context="Editor",
                                          name="go to bookmarked position "
                                               "in slot 2",
                                          parent=self)
        load_bookmark_4 = config_shortcut(lambda:
                                          self.sig_load_bookmark.emit(3),
                                          context="Editor",
                                          name="go to bookmarked position "
                                               "in slot 3",
                                          parent=self)
        load_bookmark_5 = config_shortcut(lambda:
                                          self.sig_load_bookmark.emit(4),
                                          context="Editor",
                                          name="go to bookmarked position "
                                               "in slot 4",
                                          parent=self)
        load_bookmark_6 = config_shortcut(lambda:
                                          self.sig_load_bookmark.emit(5),
                                          context="Editor",
                                          name="go to bookmarked position "
                                               "in slot 5",
                                          parent=self)
        load_bookmark_7 = config_shortcut(lambda:
                                          self.sig_load_bookmark.emit(6),
                                          context="Editor",
                                          name="go to bookmarked position "
                                               "in slot 6",
                                          parent=self)
        load_bookmark_8 = config_shortcut(lambda:
                                          self.sig_load_bookmark.emit(7),
                                          context="Editor",
                                          name="go to bookmarked position "
                                               "in slot 7",
                                          parent=self)
        load_bookmark_9 = config_shortcut(lambda:
                                          self.sig_load_bookmark.emit(8),
                                          context="Editor",
                                          name="go to bookmarked position "
                                               "in slot 8",
                                          parent=self)
        load_bookmark_10 = config_shortcut(lambda:
                                           self.sig_load_bookmark.emit(9),
                                           context="Editor",
                                           name="go to bookmarked position "
                                                "in slot 9",
                                           parent=self)
