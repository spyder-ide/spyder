...
def test_add_history(historylog):
    ...
    hw.get_option('line_numbers', False)
    hw.get_option('wrap', False)
    ...
    hw.get_option('line_numbers', True)
    hw.get_option('wrap', True)
