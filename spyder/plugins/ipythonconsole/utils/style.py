...
from pygments.token import Name, Keyword, Comment, String, Number, Punctuation, Operator
...
def create_pygments_dict(color_scheme_name):
    ...
    definition_token = (
        definition_font_style + " " + definition_font_weight + " " + definition_color
    )
    builtin_token = builtin_font_style + " " + builtin_font_weight + " " + builtin_color
    instance_token = (
        instance_font_style + " " + instance_font_weight + " " + instance_color
    )
    keyword_token = keyword_font_style + " " + keyword_font_weight + " " + keyword_color
    comment_token = comment_font_style + " " + comment_font_weight + " " + comment_color
    string_token = string_font_style + " " + string_font_weight + " " + string_color
    number_token = number_font_style + " " + number_font_weight + " " + number_color
