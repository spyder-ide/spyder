...
# Local imports
from spyder.plugins.layout.widgets.dialog import LayoutSettingsDialog, LayoutSaveDialog
...
def layout_settings_dialog(qtbot, request):
    ...
    widget = LayoutSettingsDialog(None, names, ui_names, order, active, read_only)
...
@pytest.mark.parametrize(
    "layout_save_dialog", [["test", "tester", "20", "30", "40"]], indirect=True
)
