...
def test_conda_interpreter_status(maininterpreter, qtbot):
    ...
    container._update_interpreter(path_base)
    ...
    container._update_interpreter(path_foo)
    expected = 'Conda: jedi-test-env ({})'.format(version)
    assert expected == container._get_env_info(path_foo)


def test_pyenv_interpreter_status(maininterpreter, qtbot):
    ...
    container._update_interpreter(interpreter)
...
def test_internal_interpreter_status(maininterpreter, qtbot, mocker):
