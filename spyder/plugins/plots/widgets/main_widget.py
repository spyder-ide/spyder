...
class PlotsWidget(ShellConnectMainWidget):
    ...
    def create_new_widget(self, shellwidget):
        fig_browser = FigureBrowser(parent=self, background_color=MAIN_BG_COLOR)
        ...
        fig_browser.sig_thumbnail_menu_requested.connect(self.show_thumbnail_menu)
    ...
    def remove_plot(self):
        ...
        if widget:
            if self._right_clicked_thumbnail is None:
                ...
                widget.thumbnails_sb.remove_thumbnail(self._right_clicked_thumbnail)
                # Reset the toolbar buttons to use the figviewer and not the thumbnail
                # selection
                self._right_clicked_thumbnail = None
