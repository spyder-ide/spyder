...
from spyder.utils.qthelpers import create_toolbutton, create_action
...
class ResultsTree(OneColumnTree):
    ...
    def get_actions_from_items(self, items):
        return [create_action(self, text=_('Ignore'), triggered=(lambda: self.ignore_lint_rule(item))) for item in items if self.data.get(id(item))]
