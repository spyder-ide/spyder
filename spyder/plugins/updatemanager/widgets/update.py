...
class UpdateManagerWidget(QWidget, SpyderConfigurationAccessor):
    ...
    def _start_updater(self):
        ...
        info = {
            ...
            "scale_factor": os.getenv("QT_SCALE_FACTOR", ""),
            "initial_message": _(
            ...
            "font_size": self.get_conf("app_font/size", section="appearance"),
            "monospace_font_family": self.get_conf(
                "monospace_app_font/family", section="appearance"
            ),
            "monospace_font_size": self.get_conf(
                "monospace_app_font/size", section="appearance"
            ),
        ...
        with open(info_file, "w") as f:
            json.dump(info, info_file, f)

        # Launch updater
        cmd = ["spyder-updater", "--update-info-file", info_file]
        subprocess.Popen(" ".join(cmd), shell=True)
