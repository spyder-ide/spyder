...
_qtaargs = {
    ...
    'wng_list':                [('fa.th-list', 'fa.warning'), {'options': [{'color': SpyderPalette.ICON_1}, {'offset': (0.0, 0.2), 'scale_factor': 0.75, 'color': SpyderPalette.COLOR_WARN_1, 'color_disabled': QStylePalette.COLOR_TEXT_4}]}],
    'prev_wng':                [('fa.arrow-left', 'fa.warning'), {'options': [{'color': SpyderPalette.ICON_1}, {'offset': (0.0, 0.2), 'scale_factor': 0.75, 'color': SpyderPalette.COLOR_WARN_1, 'color_disabled': QStylePalette.COLOR_TEXT_4}]}],
    'next_wng':                [('fa.arrow-right', 'fa.warning'), {'options': [{'color': SpyderPalette.ICON_1}, {'offset': (0.0, 0.2), 'scale_factor': 0.75, 'color': SpyderPalette.COLOR_WARN_1, 'color_disabled': QStylePalette.COLOR_TEXT_4}]}],
    ...
    'warning':                 [('fa.warning',), {'color': SpyderPalette.COLOR_WARN_1}],
    ...
    'dependency_warning':      [('fa.warning',), {'color': SpyderPalette.COLOR_WARN_1}],
