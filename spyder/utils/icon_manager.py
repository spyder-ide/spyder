...
class IconManager():
    ...
    def __init__(self):
        self.MAIN_FG_COLOR = QStylePalette.COLOR_TEXT_1
        ...
        self._qtaargs = {
            ...
            'run_settings':            [('fa.wrench', 'fa.play'), {'options': [{'offset':(0.0, -0.1), 'color': self.MAIN_FG_COLOR}, {'offset': (0.2, 0.125), 'color': SpyderPalette.ICON_3, 'scale_factor': 0.8}]}],
            'run_again':               [('fa.repeat', 'fa.play'), {'options': [{'offset':(0.0, -0.1), 'color': self.MAIN_FG_COLOR}, {'offset': (0.2, 0.125), 'color': SpyderPalette.ICON_3, 'scale_factor': 0.8}]}],
            ...
            'convention':              [('mdi.alpha-c-box',), {'color': SpyderPalette.ICON_2, 'scale_factor': self.BIG_ATTR_FACTOR}],
            'refactor':                [('mdi.alpha-r-box',), {'color': SpyderPalette.ICON_2, 'scale_factor': self.BIG_ATTR_FACTOR}],
            ...
            'event':                   [('mdi.alpha-e-box',), {'color': SpyderPalette.COLOR_WARN_1, 'scale_factor': self.BIG_ATTR_FACTOR}],
            'operator':                [('mdi.alpha-o-box',), {'color': SpyderPalette.COLOR_WARN_1, 'scale_factor': self.BIG_ATTR_FACTOR}],
            'type_parameter':          [('mdi.alpha-t-box',), {'color': SpyderPalette.COLOR_WARN_1, 'scale_factor': self.BIG_ATTR_FACTOR}],
            'private2':                [('spyder.circle-underscore',), {'color': SpyderPalette.COLOR_ERROR_3, 'scale_factor': self.SMALL_ATTR_FACTOR}],
            'private1':                [('spyder.circle-underscore',), {'color': SpyderPalette.COLOR_ERROR_3, 'scale_factor': self.SMALL_ATTR_FACTOR}],
            ...
            'no_match':                [('fa.circle',), {'color': SpyderPalette.GROUP_3, 'scale_factor': self.SMALL_ATTR_FACTOR}],
            ...
            'pylint':                  [('fa.search', 'fa.check'), {'options': [{'color': self.MAIN_FG_COLOR}, {'offset': (0.125, 0.125), 'color': SpyderPalette.ICON_5}]}],
