...
_qtaargs = {
    ...
    'WindowsFileIcon':         [('mdi.microsoft-windows',), {'color': MAIN_FG_COLOR}],
    'PowershellFileIcon':      [('mdi.powershell',), {'color': MAIN_FG_COLOR}],
    'DollarFileIcon':          [('fa5s.file-invoice-dollar',), {'color': MAIN_FG_COLOR}],
    'MarkdownFileIcon':        [('mdi.language-markdown',), {'color': MAIN_FG_COLOR}],
    'JsonFileIcon':            [('mdi.code-json',), {'color': MAIN_FG_COLOR}],
