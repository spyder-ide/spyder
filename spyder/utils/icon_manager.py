...
_qtaargs = {
    ...
    'color':                   [('mdi.alpha-c-box',), {'color': '#df2935', 'scale_factor': BIG_ATTR_FACTOR}],
    'enum':                    [('mdi.alpha-e-box',), {'color': '#df2935', 'scale_factor': BIG_ATTR_FACTOR}],
    'value':                   [('mdi.alpha-v-box',), {'color': '#df2935', 'scale_factor': BIG_ATTR_FACTOR}],
    'unit':                    [('mdi.alpha-u-box',), {'color': '#df2935', 'scale_factor': BIG_ATTR_FACTOR}],
    'text':                    [('mdi.alpha-t-box',), {'color': 'gray', 'scale_factor': BIG_ATTR_FACTOR}],
    'snippet':                 [('mdi.alpha-s-box',), {'color': 'gray', 'scale_factor': BIG_ATTR_FACTOR}],
    'attribute':               [('mdi.alpha-a-box',), {'color': 'magenta', 'scale_factor': BIG_ATTR_FACTOR}],
    'reference':               [('mdi.alpha-r-box',), {'color': 'magenta', 'scale_factor': BIG_ATTR_FACTOR}],
    'variable':                [('mdi.alpha-v-box',), {'color': 'magenta', 'scale_factor': BIG_ATTR_FACTOR}],
    'field':                   [('mdi.alpha-f-box',), {'color': 'magenta', 'scale_factor': BIG_ATTR_FACTOR}],
    'property':                [('mdi.alpha-p-box',), {'color': 'magenta', 'scale_factor': BIG_ATTR_FACTOR}],
    ...
    'interface':               [('mdi.alpha-i-box',), {'color':'#3775a9', 'scale_factor': BIG_ATTR_FACTOR}],
    ...
    'constructor':             [('mdi.alpha-c-box',), {'color':'#7ea67e', 'scale_factor': BIG_ATTR_FACTOR}],
