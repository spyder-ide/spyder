...
_qtaargs = {
    ...
    'filecloseall':            [('spyder.filecloseall',), [{'color': ICON_6}],
    ...
    'run':                     [('mdi.play',), {'color': ICON_3}],
    'run_settings':            [('spyder.run-settings',), {'color': ICON_6}],
    'run_again':               [('spyder.run-again',), {'color': ICON_6}],
    'run_selection':           [('spyder.run-selection',), {'color': ICON_6}],
    ...
    'plostsdeleteall':         [('spyder.plotsdeleteall',), {'color': ICON_6}],
    ...
    'package':                 [('mdi.alpha-p-box',), {'color': '#daa520', 'scale_factor': BIG_ATTR_FACTOR}],
    ...
    'string':                  [('mdi.alpha-s-box',), {'color': '#df2935', 'scale_factor': BIG_ATTR_FACTOR}],
    'number':                  [('mdi.alpha-n-box',), {'color': '#df2935', 'scale_factor': BIG_ATTR_FACTOR}],
    'boolean':                 [('mdi.alpha-b-box',), {'color': 'magenta', 'scale_factor': BIG_ATTR_FACTOR}],
    'array':                   [('mdi.alpha-a-box',), {'color': '#df2935', 'scale_factor': BIG_ATTR_FACTOR}],
    'object':                  [('mdi.alpha-o-box',), {'color': 'yellow', 'scale_factor': BIG_ATTR_FACTOR}],
    'key':                     [('mdi.alpha-k-box',), {'color': 'yellow', 'scale_factor': BIG_ATTR_FACTOR}],
    'class':                   [('mdi.alpha-c-box',), {'color':'#3775a9', 'scale_factor': BIG_ATTR_FACTOR}],
    'null':                    [('mdi.alpha-n-box',), {'color': 'magenta', 'scale_factor': BIG_ATTR_FACTOR}],
    'enum_member':             [('mdi.alpha-e-box',), {'color': '#e69c9c', 'scale_factor': BIG_ATTR_FACTOR}],
    'struct':                  [('mdi.alpha-s-box',), {'color':'#3775a9', 'scale_factor': BIG_ATTR_FACTOR}],
    'event':                   [('mdi.alpha-e-box',), {'color':'orange', 'scale_factor': BIG_ATTR_FACTOR}],
    'operator':                [('mdi.alpha-o-box',), {'color':'orange', 'scale_factor': BIG_ATTR_FACTOR}],
    'type_parameter':          [('mdi.alpha-t-box',), {'color':'orange', 'scale_factor': BIG_ATTR_FACTOR}],
