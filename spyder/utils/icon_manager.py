...
_qtaargsdark = {
    ...
    'configure':               [('fa.wrench',), {'color': 'white'}],
    'bold':                    [('fa.bold',), {'color': 'white'}],
    'italic':                  [('fa.italic',), {'color': 'white'}],
    'genprefs':                [('fa.cogs',), {'color': 'white'}],
    'exit':                    [('fa.power-off',), {'color': 'white'}],
    'run_small':               [('fa.play',), {'color': 'green'}],
    'stop':                    [('fa.stop',), {'color': 'darkred'}],
    'syspath':                 [('fa.cogs',), {'color': 'white'}],
    'font':                    [('fa.font',), {'color': 'white'}],
    'keyboard':                [('fa.keyboard-o',), {'color': 'white'}],
    'eyedropper':              [('fa.eyedropper',), {'color': 'white'}],
    'tooloptions':             [('fa.cog',), {'color': '#333333'}],
    'edit24':                  [('fa.edit',), {'color': 'white'}],
    'edit':                    [('fa.edit',), {'color': 'white'}],
    'filenew':                 [('fa.file-o',), {'color': 'white'}],
    'fileopen':                [('fa.folder-open',), {'color': 'white'}],
    'revert':                  [('fa.undo',), {'color': 'white'}],
    'filesave':                [('fa.save',), {'color': 'white'}],
    'save_all':                [('fa.save', 'fa.save'), {'options': [{'offset': (-0.2, -0.2), 'scale_factor': 0.6, 'color': 'white'}, {'offset': (0.2, 0.2), 'scale_factor': 0.6, 'color': 'white'}]}],
    'filesaveas':              [('fa.save', 'fa.pencil'), {'options': [{'offset': (-0.2, -0.2), 'scale_factor': 0.6, 'color': 'white'}, {'offset': (0.2, 0.2), 'scale_factor': 0.6, 'color': 'white'}]}],
    'print':                   [('fa.print',), {'color': 'white'}],
    'fileclose':               [('fa.close',), {'color': 'white'}],
    'filecloseall':            [('fa.close', 'fa.close', 'fa.close'), {'options': [{'scale_factor': 0.6, 'offset': (0.3, -0.3), 'color': 'white'},  {'scale_factor': 0.6, 'offset': (-0.3, -0.3), 'color': 'white'}, {'scale_factor': 0.6, 'offset': (0.3, 0.3), 'color': 'white'}]}],
    'breakpoint_big':          [('fa.circle',), {'color': 'darkred'} ],
    'breakpoint_cond_big':     [('fa.question-circle',), {'color': 'darkred'},],
    'debug':                   [('spyder.debug',), {'color': '#3775a9'}],
    'arrow-step-over':         [('spyder.step-forward',), {'color': '#3775a9'}],
    ...
    'stop_debug':              [('fa.stop',), {'color': '#3775a9'}],
    'run':                     [('fa.play',), {'color': 'green'}],
    'run_settings':            [('fa.wrench', 'fa.play'), {'options': [{'offset':(0.0, -0.1), 'color': 'white'}, {'offset': (0.2, 0.125), 'color': 'green', 'scale_factor': 0.8}]}],
    'run_again':               [('fa.repeat', 'fa.play'), {'options': [{'offset':(0.0, -0.1), 'color': 'white'}, {'offset': (0.2, 0.125), 'color': 'green', 'scale_factor': 0.8}]}],
    'run_selection':           [('spyder.run-selection',), {'color': 'white'}],
    'run_cell':                [('spyder.cell-code', 'spyder.cell-border', 'spyder.cell-play'),
                                {'options': [{'color': '#fff683'}, {'color': 'white'}, {'color': 'green'}]}],
    'run_cell_advance':        [('spyder.cell-code', 'spyder.cell-border', 'spyder.cell-play', 'spyder.cell-next'),
                                {'options': [{'color': '#fff683'}, {'color': 'white',}, {'color': 'green'}, {'color': 'red'}]}],
    'todo_list':               [('fa.th-list', 'fa.check'), {'options': [{'color': '#999999'}, {'offset': (0.0, 0.2), 'color': '#3775a9', 'color_disabled': '#748fa6'}]}],
    'wng_list':                [('fa.th-list', 'fa.warning'), {'options': [{'color': '#999999'}, {'offset': (0.0, 0.2), 'scale_factor': 0.75, 'color': 'orange', 'color_disabled': '#face7e'}]}],
    'prev_wng':                [('fa.arrow-left', 'fa.warning'), {'options': [{'color': '#999999'}, {'offset': (0.0, 0.2), 'scale_factor': 0.75, 'color': 'orange', 'color_disabled': '#face7e'}]}],
    'next_wng':                [('fa.arrow-right', 'fa.warning'), {'options': [{'color': '999999'}, {'offset': (0.0, 0.2), 'scale_factor': 0.75, 'color': 'orange', 'color_disabled': '#face7e'}]}],
    'last_edit_location':      [('fa.caret-up',), {'color': 'white'}],
    'prev_cursor':             [('fa.hand-o-left',), {'color': 'white'}],
    'next_cursor':             [('fa.hand-o-right',), {'color': 'white'}],
    'comment':                 [('fa.comment',), {'color': 'white'}],
    'indent':                  [('fa.indent',), {'color': 'white'}],
    'unindent':                [('fa.outdent',), {'color': 'white'}],
    'gotoline':                [('fa.sort-numeric-asc',), {'color': 'white'}],
    'error':                   [('fa.times-circle',), {'color': 'darkred'}],
    'warning':                 [('fa.warning',), {'color': 'orange'}],
    'todo':                    [('fa.check',), {'color': '#3775a9'}],
    'ipython_console':         [('spyder.ipython-logo-alt',), {'color': 'white'}],
    'ipython_console_t':       [('spyder.ipython-logo-alt',), {'color':'gray'}],
    'python':                  [('spyder.python-logo-up', 'spyder.python-logo-down'), {'options': [{'color': '#3775a9'}, {'color': '#ffd444'}]}],
    'pythonpath':              [('spyder.python-logo-up', 'spyder.python-logo-down'), {'options': [{'color': '#3775a9'}, {'color': '#ffd444'}]}],
    'terminated':              [('fa.circle',), {'color': 'white'}],
    'cmdprompt':               [('fa.terminal',), {'color': 'white'}],
    'cmdprompt_t':             [('fa.terminal',), {'color':'gray'}],
    'console':                 [('spyder.python-logo-up', 'spyder.python-logo-down'), {'options': [{'color': '#3775a9'}, {'color': '#ffd444'}]}],
    'findf':                   [('fa.file-o', 'fa.search'), {'options': [{'scale_factor': 1.0, 'color': 'white'}, {'scale_factor': 0.6, 'color': 'white'}]}],
    'history24':               [('fa.history',), {'color': 'white'}],
    'history':                 [('fa.history',), {'color': 'white'}],
    'help':                    [('fa.question-circle',), {'color': 'white'}],
    'lock':                    [('fa.lock',), {'color': 'white'}],
    'lock_open':               [('fa.unlock-alt',), {'color': 'white'}],
    'outline_explorer':        [('spyder.treeview',), {'color': 'white'}],
    'project_expanded':        [('fa.plus',), {'color': 'white'}],
    'dictedit':                [('fa.th-list',), {'color': 'white'}],
    'previous':                [('fa.arrow-left',), {'color': 'white'}],
    'next':                    [('fa.arrow-right',), {'color': 'white'}],
    'set_workdir':             [('fa.check',), {'color': 'white'}],
    'up':                      [('fa.arrow-up',), {'color': 'white'}],
    'down':                    [('fa.arrow-down',), {'color': 'white'}],
    'filesaveas2':             [('fa.save', 'fa.close'), {'options': [{'scale_factor': 0.8, 'offset': (-0.1, -0.1), 'color': 'white'}, {'offset': (0.2, 0.2), 'color': 'white'}]}],   # save_session_action
    'spyder':                  [('spyder.spyder-logo-background', 'spyder.spyder-logo-web', 'spyder.spyder-logo-snake'),  {'options': [{'color': '#414141'}, {'color': '#fafafa'}, {'color': '#ee0000'}]}],
    'find':                    [('fa.search',), {'color': 'white'}],
    'findnext':                [('fa.search', 'fa.long-arrow-down'), {'options':[{'scale_factor': 0.6, 'offset': (0.3, 0.0), 'color': 'white'}, {'offset': (-0.3, 0.0), 'color': 'white'}]}],
    'findprevious':            [('fa.search', 'fa.long-arrow-up'), {'options':[{'scale_factor': 0.6, 'offset': (0.3, 0.0), 'color': 'white'}, {'offset': (-0.3, 0.0), 'color': 'white'}]}],
    'replace':                 [('fa.exchange',), {'color': 'white'}],
    'undo':                    [('fa.undo',), {'color': 'white'}],
    'redo':                    [('fa.repeat',), {'color': 'white'}],
    'restart':                 [('fa.repeat',), {'çolor': '#3775a9'}],
    'editcopy':                [('fa.copy',), {'color': 'white'}],
    'editcut':                 [('fa.scissors',), {'color': 'white'}],
    'editpaste':               [('fa.clipboard',), {'color': 'white'}],
    'editdelete':              [('fa.eraser',), {'color': 'white'}],
    'editclear':               [('fa.times',), {'color': 'white'}],
    'selectall':               [('spyder.text-select-all',), {'color': 'white'}],
    'pythonpath_mgr':          [('spyder.python-logo-up', 'spyder.python-logo-down'), {'options': [{'color': '#3775a9'}, {'color': '#ffd444'}]}],
    'exit':                    [('fa.power-off',), {'color': 'darkred'}],
    'advanced':                [('fa.gear',), {'color': 'white'}],
    'bug':                     [('fa.bug',), {'color': 'white'}],
    'maximize':                [('spyder.maximize-pane',), {'color': 'white'}],
    'unmaximize':              [('spyder.minimize-pane',), {'color': 'white'}],
    'window_nofullscreen':     [('spyder.inward',), {'color': 'white'}],
    'window_fullscreen':       [('fa.arrows-alt',), {'color': 'white'}],
    'MessageBoxWarning':       [('fa.warning',), {'color': 'white'}],
    'arredit':                 [('fa.table',), {'color': 'white'}],
    'zoom_out':                [('fa.search-minus',), {'color': 'white'}],
    'zoom_in':                 [('fa.search-plus',), {'color': 'white'}],
    'home':                    [('fa.home',), {'color': 'white'}],
    'find':                    [('fa.search',), {'color': 'white'}],
    'plot':                    [('fa.line-chart',), {'color': 'white'}],
    'hist':                    [('fa.bar-chart',), {'color': 'white'}],
    'imshow':                  [('fa.image',), {'color': 'white'}],
    'insert':                  [('fa.sign-in',), {'color': 'white'}],
    'rename':                  [('fa.pencil',), {'color': 'white'}],
    'edit_add':                [('fa.plus',), {'color': 'white'}],
    'edit_remove':             [('fa.minus',), {'color': 'white'}],
    'browse_tab':              [('fa.folder-o',), {'color': 'white'}],
    'filelist':                [('fa.list',), {'color': 'white'}],
    'newwindow':               [('spyder.window',), {'color': 'white'}],
    'versplit':                [('spyder.rows',), {'color': 'white'}],
    'horsplit':                [('fa.columns',), {'color': 'white'}],
    'close_panel':             [('fa.close',), {'color': 'white'}],
    'class':                   [('spyder.circle-letter-c',), {'color':'#3775a9'}],
    'private2':                [('spyder.circle-underscore',), {'color':'#e69c9c'}],
    'private1':                [('spyder.circle-underscore',), {'color':'#e69c9c'}],
    'method':                  [('spyder.circle-letter-m',), {'color':'#7ea67e'}],
    ...
    'blockcomment':            [('spyder.circle-hash',), {'color':'grey'}],
    'cell':                    [('spyder.circle-percent',), {'color':'red'}],
    'fromcursor':              [('fa.hand-o-right',), {'color': 'white'}],
    'filter':                  [('fa.filter',), {'color': 'white'}],
    'folder_new':              [('fa.folder-o', 'fa.plus'), {'options': [{'color': 'white'}, {'scale_factor': 0.5, 'offset': (0.0, 0.1), 'color': 'white'}]}],
    'package_new':             [('fa.folder-o', 'spyder.python-logo'), {'options': [{'offset': (0.0, -0.125), 'color': 'white'}, {'offset': (0.0, 0.125), 'color': 'white'}]}],
    'vcs_commit':              [('fa.check',), {'color': 'green'}],
    'vcs_browse':              [('fa.search',), {'color': 'green'}],
    'kill':                    [('fa.warning',), {'color': 'white'}],
    'reload':                  [('fa.repeat',), {'color': 'white'}],
    'auto_reload':             [('fa.repeat', 'fa.clock-o'), {'options': [{'scale_factor': 0.75, 'offset': (-0.1, -0.1), 'color': 'white'}, {'scale_factor': 0.5, 'offset': (0.25, 0.25), 'color': 'white'}]}],
    'fileimport':              [('fa.download',), {'color': 'white'}],
    'environ':                 [('fa.th-list',), {'color': 'white'}],
    'options_less':            [('fa.minus-square',), {'color': 'white'}],
    'options_more':            [('fa.plus-square',), {'color': 'white'}],
    'ArrowDown':               [('fa.arrow-circle-down',), {'color': 'white'}],
    'ArrowUp':                 [('fa.arrow-circle-up',), {'color': 'white'}],
    'ArrowBack':               [('fa.arrow-circle-left',), {'color': 'white'}],
    'ArrowForward':            [('fa.arrow-circle-right',), {'color': 'white'}],
    'DialogApplyButton':       [('fa.check',), {'color': 'white'}],
    'DialogCloseButton':       [('fa.close',), {'color': 'white'}],
    'DirClosedIcon':           [('fa.folder-o',), {'color': 'white'}],
    'DialogHelpButton':        [('fa.life-ring',), {'color': 'darkred'}],
    'MessageBoxInformation':   [('fa.info',), {'color': '3775a9'}],
    'DirOpenIcon':             [('fa.folder-open',), {'color': 'white'}],
    'FileIcon':                [('fa.file-o',), {'color': 'white'}],
    'ExcelFileIcon':           [('fa.file-excel-o',), {'color': 'white'}],
    'WordFileIcon':            [('fa.file-word-o',), {'color': 'white'}],
    'PowerpointFileIcon':      [('fa.file-powerpoint-o',), {'color': 'white'}],
    'PDFIcon':                 [('fa.file-pdf-o',), {'color': 'white'}],
    'AudioFileIcon':           [('fa.file-audio-o',), {'color': 'white'}],
    'ImageFileIcon':           [('fa.file-image-o',), {'color': 'white'}],
    'ArchiveFileIcon':         [('fa.file-archive-o',), {'color': 'white'}],
    'VideoFileIcon':           [('fa.file-video-o',), {'color': 'white'}],
    'TextFileIcon':            [('fa.file-text-o',), {'color': 'white'}],
    'project':                 [('fa.folder-open-o',), {'color': 'white'}],
    'DriveHDIcon':             [('fa.hdd-o',), {'color': 'white'}],
    'arrow':                   [('fa.arrow-right',), {'color': 'white'}],
    'collapse':                [('spyder.inward',), {'color': 'white'}],
    'expand':                  [('fa.arrows-alt',), {'color': 'white'}],
    'restore':                 [('fa.level-up',), {'color': 'white'}],
    'collapse_selection':      [('fa.minus-square-o',), {'color': 'white'}],
    'expand_selection':        [('fa.plus-square-o',), {'color': 'white'}],
    'copywop':                 [('fa.terminal',), {'color': 'white'}],
    'editpaste':               [('fa.paste',), {'color': 'white'}],
    'editcopy':                [('fa.copy',), {'color': 'white'}],
    'edit':                    [('fa.edit',), {'color': 'white'}],
    'convention':              [('spyder.circle-letter-c',), {'color':'#3775a9'}],
    'refactor':                [('spyder.circle-letter-r',), {'color':'#3775a9'}],
    '2uparrow':                [('fa.angle-double-up',), {'color': 'white'}],
    '1uparrow':                [('fa.angle-up',), {'color': 'white'}],
    '2downarrow':              [('fa.angle-double-down',), {'color': 'white'}],
    '1downarrow':              [('fa.angle-down',), {'color': 'white'}],
    # --- Autocompletion type icons --------------
    'attribute':               [('spyder.circle-letter-a',), {'color': 'magenta'}],
    'module':                  [('spyder.circle-letter-m',), {'color': '#daa520'}],
    'class':                   [('spyder.circle-letter-c',), {'color':'#3775a9'}],
    ...
    # --- Spyder Tour --------------------------------------------------------
    'tour.close':              [('fa.close',), {'color': 'white'}],
    'tour.home':               [('fa.fast-backward',), {'color': 'white'}],
    'tour.previous':           [('fa.backward',), {'color': 'white'}],
    'tour.next':               [('fa.forward',), {'color': 'white'}],
    'tour.end':                [('fa.fast-forward',), {'color': 'white'}],
    # --- Third party plugins ------------------------------------------------
    'profiler':                [('fa.clock-o',), {'color': 'white'}],
    'pylint':                  [('fa.search', 'fa.check'), {'options': [{'color': 'white'}, {'offset': (0.125, 0.125), 'color': 'orange'}]}],
    'condapackages':           [('fa.archive',), {'color': 'white'}],
    'spyder.example':          [('fa.eye',), {'color': 'white'}],
    'spyder.autopep8':         [('fa.eye',), {'color': 'white'}],
    'spyder.memory_profiler':  [('fa.eye',), {'color': 'white'}],
    'spyder.line_profiler':    [('fa.eye',), {'color': 'white'}],
    'symbol_find':             [('fa.at',), {'color': 'white'}],
    'folding.arrow_right_off': [('fa.caret-right',), {'color': 'gray'}],
    'folding.arrow_right_on':  [('fa.caret-right',), {'color': 'white'}],
    'folding.arrow_down_off':  [('fa.caret-down',), {'color': 'gray'}],
    'folding.arrow_down_on':   [('fa.caret-down',), {'color': 'white'}],
    'lspserver':               [('fa.server',), {'color': 'white'}],
    'dependency_ok':           [('fa.check',), {'color': 'white'}],
    'dependency_warning':      [('fa.warning',), {'color': 'orange'}],
    'dependency_error':        [('fa.warning',), {'color': 'darkred'}],
}
