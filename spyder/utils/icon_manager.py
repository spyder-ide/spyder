...
class IconManager:
    ...
    def __init__(self):
        ...
        self.BIN_FILES = {
            x: "ArchiveFileIcon" for x in ["zip", "x-tar", "x-7z-compressed", "rar"]
        }
        ...
        self._qtaargs = {
            ...
            "configure": [
                ("mdi.wrench",),
                {"color": self.MAIN_FG_COLOR, "rotated": 90},
            ],
            ...
            "breakpoint_transparent": [
                ...
                {
                    "color": SpyderPalette.COLOR_ERROR_1,
                    "opacity": 0.75,
                    "scale_factor": 0.9,
                },
            ],
                    ...
                    "options": [
                        {
                            ...
                            "color_disabled": QStylePalette.COLOR_TEXT_4,
                        }
                    ]
                },
            ],
            ...
            "enum_member": [
                ("mdi.alpha-e-box",),
                {
                    "color": SpyderPalette.COLOR_ERROR_3,
                    "scale_factor": self.BIG_ATTR_FACTOR,
                },
            ],
            "struct": [
                ("mdi.alpha-s-box",),
            ...
            "event": [
                ("mdi.alpha-e-box",),
                {
                    "color": SpyderPalette.COLOR_WARN_3,
                    "scale_factor": self.BIG_ATTR_FACTOR,
                },
            ],
            "operator": [
            ...
            "private2": [
                ...
                {
                    "color": SpyderPalette.COLOR_ERROR_3,
                    "scale_factor": self.SMALL_ATTR_FACTOR,
                },
            ],
            "private1": [
                ("mdi.eye-off",),
