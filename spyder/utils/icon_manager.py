...
_qtaargs = {
    ...
    'wng_list':                [('fa.th-list', 'fa.warning'), {'options': [{'color': SpyderPalette.ICON_1}, {'offset': (0.0, 0.2), 'scale_factor': 0.75, 'color': SpyderPalette.ICON_5, 'color_disabled': QStylePalette.COLOR_TEXT_4}]}],
    'prev_wng':                [('fa.arrow-left', 'fa.warning'), {'options': [{'color': SpyderPalette.ICON_1}, {'offset': (0.0, 0.2), 'scale_factor': 0.75, 'color': SpyderPalette.ICON_5, 'color_disabled': QStylePalette.COLOR_TEXT_4}]}],
    'next_wng':                [('fa.arrow-right', 'fa.warning'), {'options': [{'color': SpyderPalette.ICON_1}, {'offset': (0.0, 0.2), 'scale_factor': 0.75, 'color': SpyderPalette.ICON_5, 'color_disabled': QStylePalette.COLOR_TEXT_4}]}],
    ...
    'warning':                 [('fa.warning',), {'color': SpyderPalette.ICON_5}],
    ...
    'keyword':                 [('mdi.alpha-k-box',), {'color': SpyderPalette.ICON_4, 'scale_factor': BIG_ATTR_FACTOR}],
    ...
    'text':                    [('mdi.alpha-t-box',), {'color': SpyderPalette.GROUP_10, 'scale_factor': BIG_ATTR_FACTOR}],
    'file':                    [('mdi.alpha-f-box',), {'color': SpyderPalette.GROUP_10, 'scale_factor': BIG_ATTR_FACTOR}],
    'snippet':                 [('mdi.alpha-s-box',), {'color': SpyderPalette.ICON_5, 'scale_factor': BIG_ATTR_FACTOR}],
    ...
    'module':                  [('mdi.alpha-m-box',), {'color': SpyderPalette.ICON_5, 'scale_factor': BIG_ATTR_FACTOR}],
    'namespace':               [('mdi.alpha-n-box',), {'color': SpyderPalette.ICON_5, 'scale_factor': BIG_ATTR_FACTOR}],
    'package':                 [('mdi.alpha-p-box',), {'color': SpyderPalette.ICON_5, 'scale_factor': BIG_ATTR_FACTOR}],
    ...
    'string':                  [('mdi.alpha-s-box',), {'color': SpyderPalette.ICON_4, 'scale_factor': BIG_ATTR_FACTOR}],
    'number':                  [('mdi.alpha-n-box',), {'color': SpyderPalette.ICON_4, 'scale_factor': BIG_ATTR_FACTOR}],
    'boolean':                 [('mdi.alpha-b-box',), {'color': 'magenta', 'scale_factor': BIG_ATTR_FACTOR}],
    'array':                   [('mdi.alpha-a-box',), {'color': SpyderPalette.ICON_4, 'scale_factor': BIG_ATTR_FACTOR}],
    ...
    'class':                   [('mdi.alpha-c-box',), {'color': SpyderPalette.ICON_2, 'scale_factor': BIG_ATTR_FACTOR}],
    'null':                    [('mdi.alpha-n-box',), {'color': 'magenta', 'scale_factor': BIG_ATTR_FACTOR}],
    'enum_member':             [('mdi.alpha-e-box',), {'color': SpyderPalette.ICON_4, 'scale_factor': BIG_ATTR_FACTOR}],
    'struct':                  [('mdi.alpha-s-box',), {'color': SpyderPalette.ICON_2, 'scale_factor': BIG_ATTR_FACTOR}],
    'event':                   [('mdi.alpha-e-box',), {'color': SpyderPalette.ICON_5, 'scale_factor': BIG_ATTR_FACTOR}],
    'operator':                [('mdi.alpha-o-box',), {'color': SpyderPalette.ICON_5, 'scale_factor': BIG_ATTR_FACTOR}],
    'type_parameter':          [('mdi.alpha-t-box',), {'color': SpyderPalette.ICON_5, 'scale_factor': BIG_ATTR_FACTOR}],
    'private2':                [('spyder.circle-underscore',), {'color': SpyderPalette.ICON_4, 'scale_factor': SMALL_ATTR_FACTOR}],
    'private1':                [('spyder.circle-underscore',), {'color': SpyderPalette.ICON_4, 'scale_factor': SMALL_ATTR_FACTOR}],
    ...
    'function':                [('mdi.alpha-f-box',), {'color': SpyderPalette.ICON_5, 'scale_factor': BIG_ATTR_FACTOR}],
    'blockcomment':            [('fa5s.hashtag',), {'color':'grey', 'scale_factor': SMALL_ATTR_FACTOR}],
    'cell':                    [('mdi.percent',), {'color':SpyderPalette.ICON_4, 'scale_factor': SMALL_ATTR_FACTOR}],
    'no_match':                [('fa.circle',), {'color': SpyderPalette.GROUP_10, 'scale_factor': SMALL_ATTR_FACTOR}],
    ...
    'folding.arrow_right_off': [('fa.caret-right',), {'color': SpyderPalette.GROUP_10}],
    'folding.arrow_right_on':  [('fa.caret-right',), {'color': MAIN_FG_COLOR}],
    'folding.arrow_down_off':  [('fa.caret-down',), {'color': SpyderPalette.GROUP_10}],
    ...
    'dependency_warning':      [('fa.warning',), {'color': SpyderPalette.ICON_5}],
