...
class IconManager():
    ...
    def __init__(self):
        ...
        self._qtaargs = {
            ...
            'configure':               [('mdi.wrench',), {'color': self.MAIN_FG_COLOR, 'rotate': (270)}],
            ...
            'debug':                   [('mdi.step-forward',), {'color': SpyderPalette.ICON_2}],
            ...
            'information':             [('mdi.information-outline',), {'color': SpyderPalette.ICON_2}],
            ...
            'restart':                 [('fa.reload',), {'color': self.MAIN_FG_COLOR}],
            ...
            'restore':                 [('mdi.subdirectory-arrow-right',), {'color': self.MAIN_FG_COLOR, 'rotate': (90)}],
