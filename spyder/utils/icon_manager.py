...
_qtaargs = {
    ...
    'bookmark':                [('mdi.bookmark',), {'color': MAIN_FG_COLOR, 'scale_factor': 0.9}],
    'bookmark_transparent':    [('mdi.bookmark',), {'color': MAIN_FG_COLOR, 'opacity': 0.5, 'scale_factor': 0.8}],
    'bookmarks':               [('mdi.bookmark', 'mdi.bookmark'), {'options': [{'scale_factor': 0.5, 'offset': (0.0, 0.0), 'color': MAIN_FG_COLOR}, {'scale_factor': 0.5, 'offset': (0.3, 0.3), 'color': MAIN_FG_COLOR}]}],
