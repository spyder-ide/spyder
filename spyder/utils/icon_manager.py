...
MAIN_FG_COLOR = QStylePalette.COLOR_TEXT_1
...
_qtaargs = {
    ...
    'run_small':               [('fa.play',), {'color': SpyderPalette.ICON_3}],
    'stop':                    [('fa.stop',), {'color': SpyderPalette.COLOR_ERROR_1}],
    ...
    'breakpoint_transparent':  [('fa.circle',), {'color': SpyderPalette.COLOR_ERROR_1, 'opacity': 0.75, 'scale_factor': 0.9}],
    'breakpoint_big':          [('fa.circle',), {'color': SpyderPalette.ICON_4, 'scale_factor': 0.9} ],
    'breakpoint_cond_big':     [('fa.question-circle',), {'color': SpyderPalette.ICON_4, 'scale_factor': 0.9},],
    ...
    'debug':                   [('spyder.debug',), {'color': SpyderPalette.ICON_2}],
    'arrow-step-over':         [('spyder.step-forward',), {'color': SpyderPalette.ICON_2}],
    'arrow-continue':          [('spyder.continue',), {'color': SpyderPalette.ICON_2}],
    'arrow-step-in':           [('spyder.step-into',), {'color': SpyderPalette.ICON_2}],
    'arrow-step-out':          [('spyder.step-out',), {'color': SpyderPalette.ICON_2}],
    'stop_debug':              [('fa.stop',), {'color': SpyderPalette.ICON_2}],
    'run':                     [('fa.play',), {'color': SpyderPalette.ICON_3}],
    'run_settings':            [('fa.wrench', 'fa.play'), {'options': [{'offset':(0.0, -0.1), 'color': MAIN_FG_COLOR}, {'offset': (0.2, 0.125), 'color': SpyderPalette.ICON_3, 'scale_factor': 0.8}]}],
    'run_again':               [('fa.repeat', 'fa.play'), {'options': [{'offset':(0.0, -0.1), 'color': MAIN_FG_COLOR}, {'offset': (0.2, 0.125), 'color': SpyderPalette.ICON_3, 'scale_factor': 0.8}]}],
    'run_selection':           [('spyder.run-selection',), {'color': MAIN_FG_COLOR}],
    'run_cell':                [('spyder.cell-code', 'spyder.cell-border', 'spyder.cell-play'),
                                {'options': [{'color': SpyderPalette.ICON_5}, {'color': MAIN_FG_COLOR}, {'color': SpyderPalette.ICON_3}]}],
    'debug_cell':              [('spyder.cell-code', 'spyder.cell-border', 'spyder.cell-play'),
                                {'options': [{'color': SpyderPalette.ICON_5}, {'color': MAIN_FG_COLOR}, {'color': SpyderPalette.ICON_2}]}],
    'run_cell_advance':        [('spyder.cell-code', 'spyder.cell-border', 'spyder.cell-play', 'spyder.cell-next'),
                                {'options': [{'color': SpyderPalette.ICON_5}, {'color': MAIN_FG_COLOR,}, {'color': SpyderPalette.ICON_3}, {'color': SpyderPalette.ICON_4}]}],
    'todo_list':               [('fa.th-list', 'fa.check'), {'options': [{'color': SpyderPalette.ICON_1}, {'offset': (0.0, 0.2), 'color': SpyderPalette.ICON_2, 'color_disabled': QStylePalette.COLOR_TEXT_4}]}],
    'wng_list':                [('fa.th-list', 'fa.warning'), {'options': [{'color': SpyderPalette.ICON_1}, {'offset': (0.0, 0.2), 'scale_factor': 0.75, 'color': SpyderPalette.COLOR_WARN_2, 'color_disabled': QStylePalette.COLOR_TEXT_4}]}],
    'prev_wng':                [('fa.arrow-left', 'fa.warning'), {'options': [{'color': SpyderPalette.ICON_1}, {'offset': (0.0, 0.2), 'scale_factor': 0.75, 'color': SpyderPalette.COLOR_WARN_2, 'color_disabled': QStylePalette.COLOR_TEXT_4}]}],
    'next_wng':                [('fa.arrow-right', 'fa.warning'), {'options': [{'color': SpyderPalette.ICON_1}, {'offset': (0.0, 0.2), 'scale_factor': 0.75, 'color': SpyderPalette.COLOR_WARN_2, 'color_disabled': QStylePalette.COLOR_TEXT_4}]}],
    ...
    'error':                   [('fa.times-circle',), {'color': SpyderPalette.COLOR_ERROR_1}],
    'warning':                 [('fa.warning',), {'color': SpyderPalette.COLOR_WARN_2}],
    'information':             [('fa.info-circle',), {'color': SpyderPalette.ICON_2}],
    'hint':                    [('fa.lightbulb-o',), {'color': SpyderPalette.ICON_2}],
    'todo':                    [('fa.exclamation',), {'color': SpyderPalette.ICON_2}],
    ...
    'exit':                    [('fa.power-off',), {'color': SpyderPalette.COLOR_ERROR_1}],
    ...
    'vcs_commit':              [('fa.check',), {'color': SpyderPalette.ICON_3}],
    'vcs_browse':              [('fa.search',), {'color': SpyderPalette.ICON_3}],
    ...
    'DialogHelpButton':        [('fa.life-ring',), {'color': SpyderPalette.COLOR_ERROR_1}],
    ...
    'convention':              [('mdi.alpha-c-box',), {'color': SpyderPalette.ICON_2, 'scale_factor': BIG_ATTR_FACTOR}],
    'refactor':                [('mdi.alpha-r-box',), {'color': SpyderPalette.ICON_2, 'scale_factor': BIG_ATTR_FACTOR}],
    ...
    'keyword':                 [('mdi.alpha-k-box',), {'color': SpyderPalette.GROUP_9, 'scale_factor': BIG_ATTR_FACTOR}],
    'color':                   [('mdi.alpha-c-box',), {'color': SpyderPalette.ICON_5, 'scale_factor': BIG_ATTR_FACTOR}],
    'enum':                    [('mdi.alpha-e-box',), {'color': SpyderPalette.ICON_5, 'scale_factor': BIG_ATTR_FACTOR}],
    'value':                   [('mdi.alpha-v-box',), {'color': SpyderPalette.ICON_5, 'scale_factor': BIG_ATTR_FACTOR}],
    'constant':                [('mdi.alpha-c-box',), {'color': SpyderPalette.ICON_5, 'scale_factor': BIG_ATTR_FACTOR}],
    'unit':                    [('mdi.alpha-u-box',), {'color': SpyderPalette.ICON_5, 'scale_factor': BIG_ATTR_FACTOR}],
    'text':                    [('mdi.alpha-t-box',), {'color': SpyderPalette.GROUP_3, 'scale_factor': BIG_ATTR_FACTOR}],
    'file':                    [('mdi.alpha-f-box',), {'color': SpyderPalette.GROUP_3, 'scale_factor': BIG_ATTR_FACTOR}],
    'snippet':                 [('mdi.alpha-s-box',), {'color': SpyderPalette.GROUP_11, 'scale_factor': BIG_ATTR_FACTOR}],
    'attribute':               [('mdi.alpha-a-box',), {'color': SpyderPalette.GROUP_12, 'scale_factor': BIG_ATTR_FACTOR}],
    'reference':               [('mdi.alpha-r-box',), {'color': SpyderPalette.ICON_5, 'scale_factor': BIG_ATTR_FACTOR}],
    'variable':                [('mdi.alpha-v-box',), {'color': SpyderPalette.ICON_5, 'scale_factor': BIG_ATTR_FACTOR}],
    'field':                   [('mdi.alpha-a-box',), {'color': SpyderPalette.ICON_5, 'scale_factor': BIG_ATTR_FACTOR}],
    'property':                [('mdi.alpha-p-box',), {'color': SpyderPalette.ICON_5, 'scale_factor': BIG_ATTR_FACTOR}],
    'module':                  [('mdi.alpha-m-box',), {'color': SpyderPalette.GROUP_5, 'scale_factor': BIG_ATTR_FACTOR}],
    'namespace':               [('mdi.alpha-n-box',), {'color': SpyderPalette.GROUP_5, 'scale_factor': BIG_ATTR_FACTOR}],
    'package':                 [('mdi.alpha-p-box',), {'color': SpyderPalette.GROUP_5, 'scale_factor': BIG_ATTR_FACTOR}],
    'class':                   [('mdi.alpha-c-box',), {'color': SpyderPalette.ICON_2, 'scale_factor': BIG_ATTR_FACTOR}],
    'interface':               [('mdi.alpha-i-box',), {'color': SpyderPalette.ICON_5, 'scale_factor': BIG_ATTR_FACTOR}],
    'string':                  [('mdi.alpha-s-box',), {'color': SpyderPalette.GROUP_9, 'scale_factor': BIG_ATTR_FACTOR}],
    'number':                  [('mdi.alpha-n-box',), {'color': SpyderPalette.GROUP_9, 'scale_factor': BIG_ATTR_FACTOR}],
    'boolean':                 [('mdi.alpha-b-box',), {'color': SpyderPalette.GROUP_12, 'scale_factor': BIG_ATTR_FACTOR}],
    'array':                   [('mdi.alpha-a-box',), {'color': SpyderPalette.GROUP_9, 'scale_factor': BIG_ATTR_FACTOR}],
    'object':                  [('mdi.alpha-o-box',), {'color': SpyderPalette.ICON_5, 'scale_factor': BIG_ATTR_FACTOR}],
    'key':                     [('mdi.alpha-k-box',), {'color': SpyderPalette.ICON_5, 'scale_factor': BIG_ATTR_FACTOR}],
    'class':                   [('mdi.alpha-c-box',), {'color': SpyderPalette.ICON_2, 'scale_factor': BIG_ATTR_FACTOR}],
    'null':                    [('mdi.alpha-n-box',), {'color': SpyderPalette.GROUP_12, 'scale_factor': BIG_ATTR_FACTOR}],
    'enum_member':             [('mdi.alpha-e-box',), {'color': SpyderPalette.COLOR_ERROR_3, 'scale_factor': BIG_ATTR_FACTOR}],
    'struct':                  [('mdi.alpha-s-box',), {'color': SpyderPalette.ICON_2, 'scale_factor': BIG_ATTR_FACTOR}],
    'event':                   [('mdi.alpha-e-box',), {'color': SpyderPalette.COLOR_WARN_1, 'scale_factor': BIG_ATTR_FACTOR}],
    'operator':                [('mdi.alpha-o-box',), {'color': SpyderPalette.COLOR_WARN_1, 'scale_factor': BIG_ATTR_FACTOR}],
    'type_parameter':          [('mdi.alpha-t-box',), {'color': SpyderPalette.COLOR_WARN_1, 'scale_factor': BIG_ATTR_FACTOR}],
    'private2':                [('spyder.circle-underscore',), {'color': SpyderPalette.COLOR_ERROR_3, 'scale_factor': SMALL_ATTR_FACTOR}],
    'private1':                [('spyder.circle-underscore',), {'color': SpyderPalette.COLOR_ERROR_3, 'scale_factor': SMALL_ATTR_FACTOR}],
    'method':                  [('mdi.alpha-m-box',), {'color': SpyderPalette.ICON_3, 'scale_factor': BIG_ATTR_FACTOR}],
    'constructor':             [('mdi.alpha-c-box',), {'color': SpyderPalette.ICON_5, 'scale_factor': BIG_ATTR_FACTOR}],
    'function':                [('mdi.alpha-f-box',), {'color': SpyderPalette.COLOR_WARN_1, 'scale_factor': BIG_ATTR_FACTOR}],
    'blockcomment':            [('fa5s.hashtag',), {'color':'grey', 'scale_factor': SMALL_ATTR_FACTOR}],
    'cell':                    [('mdi.percent',), {'color':SpyderPalette.GROUP_9, 'scale_factor': SMALL_ATTR_FACTOR}],
    'no_match':                [('fa.circle',), {'color': SpyderPalette.GROUP_3, 'scale_factor': SMALL_ATTR_FACTOR}],
    ...
    'pylint':                  [('fa.search', 'fa.check'), {'options': [{'color': MAIN_FG_COLOR}, {'offset': (0.125, 0.125), 'color': SpyderPalette.ICON_5}]}],
    ...
    'folding.arrow_right_off': [('fa.caret-right',), {'color': SpyderPalette.GROUP_3}],
    'folding.arrow_right_on':  [('fa.caret-right',), {'color': MAIN_FG_COLOR}],
    'folding.arrow_down_off':  [('fa.caret-down',), {'color': SpyderPalette.GROUP_3}],
    ...
    'dependency_warning':      [('fa.warning',), {'color': SpyderPalette.COLOR_WARN_2}],
    'dependency_error':        [('fa.warning',), {'color': SpyderPalette.COLOR_ERROR_1}],
    'broken_image':            [('mdi.image-broken-variant',), {'color': MAIN_FG_COLOR}],
    # --- Status bar --------------------------------------------------------
    'code_fork':               [('fa.code-fork',), {'color': MAIN_FG_COLOR}],
    'statusbar':               [('mdi.dock-bottom',), {'color': MAIN_FG_COLOR}],
}
