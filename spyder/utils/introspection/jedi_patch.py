...
def apply():
    ...
    if is_module_installed('jedi', '=0.9.0'):
        from jedi.evaluate.compiled import builtin, _create_from_name, debug
        ...
        from jedi.evaluate.compiled import debug
        ...
        def _execute_function(self, params):
            ...
            if self.type != 'funcdef':
                return
            types = set([])
            types |= set(numpy_docstr.find_return_types(self.parent_context, self))
