...
# =============================================================================
@pytest.mark.skipif(
    sys.platform.startswith("linux") or not running_in_ci(),
...
def test_run_python_script_in_terminal_blank_wdir(scriptpath_with_blanks, qtbot):
    """
    Test running a Python script in an external terminal when specifying
    explicitly the working directory.
    """
    ...
    run_python_script_in_terminal(
        scriptpath_with_blanks.strpath,
        scriptpath_with_blanks.dirname,
        "",
        False,
        False,
        "",
...
@pytest.mark.skipif(not sys.platform.startswith("linux"), reason="Test for linux only")
