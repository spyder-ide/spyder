...
def test_stringmatching_full():
    ...
    full_results = get_search_scores(
        "lay",
        names,
        template=template,
    )
    ...
    assert full_results == [
        ...
        ("switch to breakpoints", "switch to breakpoints", -1),
        ("switch to console", "switch to console", -1),
        ("switch to editor", "switch to editor", -1),
        ("switch to explorer", "switch to explorer", -1),
        ("switch to find_in_files", "switch to find_in_files", -1),
        ("switch to historylog", "switch to historylog", -1),
        ("switch to help", "switch to help", -1),
        ("switch to ipython_console", "switch to ipython_console", -1),
        ("switch to onlinehelp", "switch to onlinehelp", -1),
        ("switch to outline_explorer", "switch to outline_explorer", -1),
        ("switch to project_explorer", "switch to project_explorer", -1),
        ("switch to variable_explorer", "switch to variable_explorer", -1),
        ...
        ("conditional breakpoint", "conditional breakpoint", -1),
        ...
        ("file list management", "file list management", -1),
        ...
        ("next cursor position", "next cursor position", -1),
        ...
        ("show/hide project explorer", "show/hide project explorer", -1),
...
def test_stringmatching_order_filter():
    ...
    order_filter_results = get_search_scores(
        "lay", names, template=template, valid_only=True, sort=True
    )
