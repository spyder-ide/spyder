...
DEFAULTS = [
            ...
            ('emacs_shortcuts',
              ...
              'editor/start of document': 'Meta+Left',
              'editor/end of document': 'Meta+Right',
              # -- In widgets/editor
              'editor/inspect current object': 'Ctrl+X, Ctrl+I',
              'editor/go to line': 'Ctrl+X, Ctrl+L',
              'editor/go to previous file': 'Ctrl+Tab',
              'editor/go to next file': 'Ctrl+Shift+Tab',
              '_/file switcher': 'Meta+Shift+P',
              # -- In spyder.py
              'editor/find text': "Ctrl+S",
              'editor/find next': "F3",
              'editor/find previous': "Ctrl+R",
              'editor/replace text': "Ctrl+X, Ctrl+H",
              'editor/undo': 'Meta+Backspace',
              'editor/redo': 'Ctrl+X, Ctrl+Y',
              'editor/cut': 'Ctrl+W',
              'editor/copy': 'Ctrl+C',
              'editor/paste': 'Ctrl+Y',
              'editor/delete': 'Delete',
              ...
              'editor/save file': "Ctrl+X, Ctrl+W",
              'editor/save all': "Ctrl+Alt+S",
              'editor/save as': 'Ctrl+Shift+S',
              'editor/close all': "Ctrl+Shift+W",
            }),
