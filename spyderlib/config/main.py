            ...
            ('color_schemes',
             {
              ...
              'emacs/docstring':  ('#00aa00', False, True),
              ...
              'idle/docstring':   ('#00aa00', False, False),
              ...
              'monokai/docstring':   ('#e6db74', False, False),
              ...
              'pydev/docstring':  ('#00aa00', False, True),
              ...
              'scintilla/docstring':  ('#7f007f', False, False),
              ...
              'spyder/docstring':  ('#00aa00', False, False),
              ...
              'spyder/dark/docstring':  ('#11a642', False, True),
              ...
              'zenburn/docstring':  ('#cc9393', False, False),
