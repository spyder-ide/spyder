...
_qtaargs = {
    ...
    'run_settings':            [('fa.wrench', 'fa.play'), {'options': [{'offset':(-0.1, -0.1), 'scale_factor': 0.75}, {'offset': (0.0, 0.125), 'color': 'green','scale_factor': 0.75}]}],
    'run_again':               [('fa.repeat', 'fa.play'), {'options': [{'offset':(-0.1, -0.1), 'scale_factor': 0.75}, {'offset':(0.1, 0.125), 'color': 'green', 'scale_factor': 0.75}]}],
    'run_selection':           [('spyder.run-selection',), {}],
    'run_cell':                [('spyder.cell-page', 'spyder.cell-code', 'spyder.cell-play'), 
                                {'options': [{'color': 'white'}, {'color': '#ffd444'}, {'color': 'green'}]}],
    'run_cell_advance':        [('spyder.cell-page', 'spyder.cell-code', 'spyder.cell-play', 'spyder.cell-next'), 
                                {'options': [{'color': 'white'}, {'color': '#ffd444'}, {'color': 'green'}, {'color': 'red'}]}],
