...
_qtaargs = {
    ...
    'run_settings':            [('fa.wrench', 'fa.play'), {'options': [{'offset':(0.0, -0.1)}, {'offset': (0.1, 0.125), 'color': 'green', 'scale_factor': 0.8}]}],
    ...
    'run_cell':                [('spyder.cell-page', 'spyder.cell-page-shadow', 'spyder.cell-code', 'spyder.cell-border', 'spyder.cell-play'),
                                {'options': [{'color': 'white'}, {'color': 'gray'}, {'color': '#fff683'}, {'color': 'gray'}, {'color': 'green'}]}],
    'run_cell_advance':        [('spyder.cell-page', 'spyder.cell-page-shadow', 'spyder.cell-code', 'spyder.cell-border', 'spyder.cell-play', 'spyder.cell-next'),
                                {'options': [{'color': 'white'}, {'color': 'gray'}, {'color': '#fff683'}, {'color': 'gray'}, {'color': 'green'}, {'color': 'red'}]}],
