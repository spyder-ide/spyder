...
#            btn.setEnabled(count > 1)
    ...
    def run_selection(self):
        ...
        If no text is selected, then execute current line and advance cursor
        to next line. If cursor is on last line and that line is not empty,
        then add a new blank line and move the cursor there. If cursor is on
        last line and that line is empty, then do not move cursor.
        """
